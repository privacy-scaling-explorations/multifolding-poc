...
mod tests {
    ...
    #[test]
    fn test_mle() {
        let A = vec![vec![Fr::from(2u64), Fr::from(3u64), Fr::from(4u64), Fr::from(4u64)],
                     vec![Fr::from(4u64), Fr::from(11u64), Fr::from(14u64), Fr::from(14u64)],
                     vec![Fr::from(2u64), Fr::from(8u64), Fr::from(17u64), Fr::from(17u64)],
                     vec![Fr::from(420u64), Fr::from(4u64), Fr::from(2u64), Fr::from(0u64)]];
